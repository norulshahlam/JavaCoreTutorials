...
/*
1. we show that we can force an error if certain user input doesnt meet requirements  
2. we can use 1 try with many catch to handle diff type of exceptions defined by us
*/
