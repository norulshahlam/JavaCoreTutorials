...
Let's discuss about that in this specific section. We'll talk about what is a functional interface and
...
public class intro1 {
  ...
  public static void main(String[] args) {
    ...
    List<Integer> numbers = List.of(12, 9, 13, 4, 6, 2, 4, 12, 15);
     ...
     /*
    we see that filter takes a Predicate as argument
    map take a Function as argument
    forEach takes a Consumer as argument
    */
    ...
    //3. deep layer - all 3 above is a functional interface and below is the implementation
