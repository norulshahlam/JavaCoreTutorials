  ...
  public static void main(String[] args) {
    List<Course> courses = List.of(
        ...
        new Course("Kubernetes",    "Cloud",         91, 20000));
           ...
           int a1= courses.stream().filter(course -> course.getReviewScore() > 90)
           ...
           long a3= courses.stream().filter(course -> course.getReviewScore() > 90)
           .mapToInt(Course::getNoOfStudents)
           .count();
           /****** get max of filtered reesults *******/
           OptionalInt a4= courses.stream().filter(course -> course.getReviewScore() > 90)
           .mapToInt(Course::getNoOfStudents)
           .max();
           /****** count the filtered reesults *******/
           OptionalInt a5= courses.stream().filter(course -> course.getReviewScore() > 90)
           .mapToInt(Course::getNoOfStudents)
           .min();
