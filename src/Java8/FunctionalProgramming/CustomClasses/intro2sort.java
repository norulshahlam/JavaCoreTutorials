...
public class intro2sort {
  ...
  public static void main(String[] args) {
    List<Course> courses = List.of(
        ...
        //
        //sort default
        List<Course> a1= courses.stream()
        .sorted(Comparator.comparingInt(Course::getNoOfStudents))
        .collect(Collectors.toList());
      
        // b. sort reverse
        List<Course> b1 = courses.stream()
        ...
        .collect(Collectors.toList());
          ...
          .sorted(Comparator.comparingInt(Course::getNoOfStudents).thenComparing(Course::getReviewScore))
          .collect(Collectors.toList());
        
          //d. sort by students then reviews - reversed     
          List<Course> d1 = courses.stream()
          .sorted(Comparator.comparingInt(Course::getNoOfStudents).thenComparing(Course::getReviewScore).reversed())
          .collect(Collectors.toList());
        ...
        List<Course> a2 = courses.stream()
        .sorted(comparingByNoOfStudentsIncreasing)
        .collect(Collectors.toList());

        // b. sort by students - reverse
        Comparator<Course> comparingByNoOfStudentsDereasing 
        = Comparator.comparingInt(Course::getNoOfStudents).reversed();
  
        List<Course> b2 = courses.stream()
        .sorted(comparingByNoOfStudentsDereasing)
        .collect(Collectors.toList());
        ...
        //d. sort by students then reviews - reversed 
        Comparator<Course> comparingByNoOfStudentsAndReviewsReversed 
        = Comparator.comparingInt(Course::getNoOfStudents).thenComparing(Course::getReviewScore).reversed();
  
        List<Course> d2 = courses.stream()
        .sorted(comparingByNoOfStudentsAndReviewsReversed)
        .collect(Collectors.toList());
        //
        //
        //
