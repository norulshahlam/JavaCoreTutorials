...
public class intro4minmax {
  ...
  public static void main(String[] args) {
    List<Course> courses = List.of(
        ...
        Optional<Course> a4= courses.stream().filter(course -> course.getReviewScore() > 95)
        .findFirst();

        /******* 4. get any element of filtered result *********/
        Optional<Course> a5= courses.stream().filter(course -> course.getReviewScore() > 95)
        .findAny();

        /************* 5. optional *********/
        Optional<Course> a6= courses.stream().filter(course -> course.getReviewScore() <90)
        .findFirst();
        //
        //
        //
